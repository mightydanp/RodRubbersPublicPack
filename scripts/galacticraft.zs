...
var RCplateIron = <ore:plateIron>;
var RCplateSteel = <ore:plateSteel>;
...
# Specialities
furnace.remove(<GalacticraftMars:item.itemBasicAsteroids:5>, GCoreIlmenite);
//furnace.remove(<GalacticraftMars:item.itemBasicAsteroids:5>, GCoreAluminiumAsteroid);
furnace.remove(<GalacticraftMars:item.itemBasicAsteroids:5>, shardTitanium);
